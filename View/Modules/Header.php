<div class="MainHeader">
    ...
    <div class="HeaderTop">
        <div class="MainFrame">
            ...
            <div class="HeaderTopRight">
                <div class="HTRLogo">
                    <a href="Home"><img src="./Asset/Images/Logo/MainLogo.png" alt="MainLogo"></a>
                </div>
                <div class="HTRSearch">
    ...
    <nav class="HeaderBottom">
        <div class="MainFrame">
            ...
            <!-- End of HeaderBottom Right -->
            <!-- Start of HeaderBottom Left -->
            <div class="HeaderBottomLeft">
                <input type="button" value="فروش در گردونه" name="btnContribute">
            </div>
            <!-- End of HeaderBottom Left -->
        </div>
    </nav>
    <!-- End of HeaderBottom -->
</div>